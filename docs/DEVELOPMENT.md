...
### 2026-01-20 P2-B2 バックエンド統一メッセージフォーマット

| Commit | 変更内容 |
|--------|----------|
| `73a68c7` | P2-B2: emailConsumer.ts に generateReminderEmail 追加、threadsRemind.ts を reminder タイプに変更 |

**メールテンプレート:**
- `additional_slots` - 追加候補通知（既存・DoD達成済み）
- `reminder` - リマインド（新規追加）
- `invite` - 初回招待
